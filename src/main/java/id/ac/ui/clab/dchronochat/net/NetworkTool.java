...
public class NetworkTool {
    ...
    private final static String FILE_PREFIX = "/ndn/broadcast/ChronoFile";
    private Context mContext;
    private String mPrefix = "/ndn/test/broadcast/ChronoChat";
    private String mFilePrefix = "/ndn/test/broadcase/ChronoFile";
...
//        Toast.makeText(m_ctx, "create netTool!", Toast.LENGTH_LONG);
    ...
    public boolean sendMsg(String ip) {
        ...
        Name name1 = new Name(mFilePrefix + "/" + System.currentTimeMillis() + "/000000" + mHubPrefix
                + "/111111" + mChatRoom + "/222222/" + mIP + "/333333/" + mSession);

        try {
            face.expressInterest(name, echo, echo);
            face.expressInterest(name1,echo,echo);
        ...
        private void registerBroadcastPrefix(String str) {
            ...
            try {
                ...
                nfdcHelper.ribRegisterPrefix(new Name(PREFIX + mChatRoom), faceID,
                        10, true, false);
                nfdcHelper.ribRegisterPrefix(new Name(FILE_PREFIX + mChatRoom), faceID,
                        10, true, false);
